        ...
        .show(ui, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if !app.content.suggestions_tracks.is_empty() {
                    ui.add_space(15.0);
                    ui.label(
                        egui::RichText::new(format!("({} tracks)", app.content.suggestions_tracks.len()))
                            .size(16.0)
            ...
            match app.content.suggestions_sort_order {
                ...
                crate::app::player_app::SuggestionsSortOrder::ArtistAZ => {
                    filtered_tracks.sort_by(|a, b| a.user.username.to_lowercase().cmp(&b.user.username.to_lowercase()));
                }
            }
            ...
            ui.horizontal(|ui| {
                ...
                let sort_response = egui::ComboBox::from_id_source("suggestions_sort")
                    ...
                    .show_ui(ui, |ui| {
                        ui.selectable_value(&mut app.content.suggestions_sort_order, crate::app::player_app::SuggestionsSortOrder::Default, "Default");
                        ui.selectable_value(&mut app.content.suggestions_sort_order, crate::app::player_app::SuggestionsSortOrder::TitleAZ, "Title (A-Z)");
                        ui.selectable_value(&mut app.content.suggestions_sort_order, crate::app::player_app::SuggestionsSortOrder::ArtistAZ, "Artist (A-Z)");
                    });
            ...
            if let Some(action) = render_suggestions_grid(app, ui, &page_tracks) {
                match action {
                    ...
                    SuggestionsAction::PlayAsPlaylist => {
                        log::info!("[Suggestions] Loading all {} suggestions as playlist", filtered_tracks.len());
                        app.audio.playback_queue.load_tracks(filtered_tracks.clone());
