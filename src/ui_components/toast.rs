    ...
    pub fn render(&mut self, ui: &mut egui::Ui) {
        ...
        for (i, toast) in self.toasts.iter().enumerate() {
            ...
            ui.painter().rect_stroke(
                ...
                egui::Stroke::new(
                    1.0,
                    Color32::from_rgba_premultiplied(255, 255, 255, (100.0 * opacity) as u8),
                ),
            ...
            ui.painter().text(
                ...
                Color32::from_rgba_premultiplied(255, 255, 255, (255.0 * opacity) as u8),
            );

            // Message (center, allowing for icon space)
            let text_rect = Rect::from_min_max(Pos2::new(rect.min.x + 45.0, rect.min.y), rect.max);
            ui.painter().text(
                text_rect.center(),
