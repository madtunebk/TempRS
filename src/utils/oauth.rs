...
fn generate_pkce_pair() -> (String, String) {
    ...
    let combined = format!("{}{}", URL_SAFE_NO_PAD.encode(random_bytes), machine_fp);
...
impl OAuthManager {
    ...
    pub async fn exchange_code_for_token(&self, code: &str) -> Result<TokenData, String> {
        ...
        let expires_in = json["expires_in"].as_u64().unwrap_or(3600); // Default to 1 hour
